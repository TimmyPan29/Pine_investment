...
if(state==4)
    ...
    line.new(x1=bar_index-1, y1=close_SBU, x2=bar_index +100, y2=close_SBU, width=2, color=color.black)
    line.new(x1=bar_index-1, y1=close_SBD, x2=bar_index +100, y2=close_SBD, width=2, color=color.black)
