...
input int      symbol1Off    = 0     ;
input Treasure tr2           = Forex ;
input int      symbol_n2     = 0     ;
input int      symbol2Off    = 0     ;
input Treasure tr3           = Forex ;
input int      symbol_n3     = 0     ;
input int      symbol3Off    = 0     ;
input Treasure tr4           = Forex ;
input int      symbol_n4     = 0     ;
input int      symbol4Off    = 0     ;
input Treasure tr5           = Forex ;
input int      symbol_n5     = 0     ;
input int      symbol5Off    = 0     ;
input Treasure tr6           = Forex ;
input int      symbol_n6     = 0     ;
input int      symbol6Off    = 0     ;
input Treasure tr7           = Forex ;
input int      symbol_n7     = 0     ;
input int      symbol7Off    = 0     ;
input Treasure tr8           = Forex ;
input int      symbol_n8     = 0     ;
input int      symbol8Off    = 0     ;
input Treasure tr9           = Forex ;
input int      symbol_n9     = 0     ;
input int      symbol9Off    = 0     ;
input Treasure tr10          = Forex ;
input int      symbol_n10    = 0     ;
input int      symbol10Off   = 0     ;
...
void OnTick() {
    ...
    if(!inmonitor){
        for(int k=0; k<10; ++k){
            ...
            for (int i=0; i<(PERIODX4); ++i){
                ...
                fc.RenewQuo_Rm(i+1, helper, quooffset[k]);
                Bosarr[i] = BOS(i+1);
                fvgarr[i] = FVG(i+1);
                rd   = fc.GetRaw();
    ...
    if(rd.RenewRawdata){
        for (int i=0; i<(PERIODX4); ++i){
                ...
                BOSMonitor(Bosarr[i], rd, helper, fvgarr[i], i);
            }
    }
