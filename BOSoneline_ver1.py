//@version=5
indicator("hr,week sbd sbu", shorttitle="BOSoneline", overlay=true,max_labels_count = 500)
...
if(state==1 and barCount>2) //從第三點開始
    if(close!=Buff_close3)
        ...
        label.new(x=barCount-1,y=high,text="是在哈囉")
        state := bar_index==last_bar_index-x? 5 : 1
